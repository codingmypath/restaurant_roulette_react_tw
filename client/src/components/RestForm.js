...
const RestForm = () => {
    ...
    return (
        <div className="font-nunito text-center w-full h-full bg-white bg-no-repeat bg-cover m-auto">
            {/* <Header /> */}
            <section className="w-full flex flex-col mt-20 mx-auto my-0">
        <section className="bg-mobile-back xl:bg-[url('./images/toast.jpg')] bg-no-repeat bg-cover bg-center h-[450px] bg-white p-20 text-black">
            <h1 className="text-4xl pt-10 xl:pt-24 md:text-5xl mr-0 md:pl-[20rem] xl:pl-[35rem]">LET US TAKE THE DECISION OUT OF DINING!</h1>  
            <h3 className="mt-5 p-1 md:pl-[20rem] xl:pl-[35rem] text-xl">We pick the restaurant when you are having trouble deciding where to go eat!</h3>
        </section>
        <section className="h-full bg-contain bg-right bg-no-repeat bg-[#ebe9ec] pt-8 p-5 xl:bg-[url('./images/coffee1.png')]">
            <form className='h-full w-full text-center m-auto rounded-smp pt-8 h-[625px]' onSubmit={handleSubmit}>
                ...
                <h3 className="p-1 mt-5 text-xl">Categories</h3>
                <section className="flex flex-wrap justify-center max-w-xl m-auto">
            ...
            <input className="c-white bg-[#899b0e] border-none cursor-pointer text-md/[17px] rounded-[3px] m-1.5 px-5 py-2 mb-2 hover:bg-[#718109]" type="submit" value="Submit"></input>
        ...
        <section className="text-center bg-pasta-back bg-center bg-no-repeat bg-cover">
            {products.map((item) => (
            <section className="w-full m-auto h-[1000px] p-2.5" key={item.id}>
                <h2 className="font-semibold text-xl mb-1 mt-0.5 pt-5">Restaurant</h2>
                <h2 className="mt-0 text-[#A41629] text-2xl">{item.name}</h2>
                <h2 className="mt-4 mb-1 text-xl font-semibold">Rating</h2>
                <section className="flex flex-row justify-center">
                    {item.rating === 5 ? (<div className="p-0.5 text-2xl text-[#A41629]"><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /></div>) : 
                        item.rating === 4.5 ? (<div className="p-0.5 text-2xl text-[#A41629]"><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStarHalfStroke} /></div>) : 
                            item.rating === 4 ? (<div className="p-0.5 text-2xl text-[#A41629]"><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /></div>) : 
                                item.rating === 3.5 ? (<div className="p-0.5 text-2xl text-[#A41629]"><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStarHalfStroke} /></div>) : 
                                    item.rating === 3 ? (<div className="p-0.5 text-2xl text-[#A41629]"><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /></div>) :
                                        item.rating === 2.5 ? (<div className="p-0.5 text-2xl text-[#A41629]"><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStarHalfStroke} /></div>) :
                                            item.rating === 2 ? (<div className="p-0.5 text-2xl text-[#A41629]"><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStar} /></div>) :
                                                item.rating === 1.5 ? (<div className="p-0.5 text-2xl text-[#A41629]"><FontAwesomeIcon icon={faStar} /><FontAwesomeIcon icon={faStarHalfStroke} /></div>) :
                                                    item.rating === 3 ? (<div className="p-0.5 text-2xl text-[#A41629]"><FontAwesomeIcon icon={faStar} /></div>) :
                ...
                <img className="w-96 mb-2.5 rounded-sm m-auto p-2.5 pb-5 max-h-xs" src={item.image_url} alt="Yelp restaurant" />
            </section>
            ))}
        </section>
